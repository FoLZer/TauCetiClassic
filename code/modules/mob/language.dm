...
/datum/language/human
	...
	colour = "rough"
	key = list("1")
	allowed_species = list(IPC, DIONA, SKRELL, UNATHI, TAJARAN, VOX, BIONIC, VULPKANIN)
...
/datum/language/trader
	...
	colour = "say_quote"
	key = list("2")
	allowed_species = list(IPC, HUMAN, DIONA, SKRELL, UNATHI, TAJARAN, VOX, BIONIC, VULPKANIN)
