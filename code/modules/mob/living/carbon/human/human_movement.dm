/mob/living/carbon/human/movement_delay()
	...
	if(is_type_organ(O_HEART, /obj/item/organ/internal/heart/ipc) || is_type_organ(O_HEART, /obj/item/organ/internal/heart/bionic)) // IPC's heart is a servomotor, damaging it influences speed.
